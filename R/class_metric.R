new_metric <- function(.f, self_distance, sort_decreasing, is_symmetric) {
...
#' @param self_distance The distance between a vector and itself. For the Euclidean
...
#' @export
Metric <- function(.f, self_distance = .f(1, 1), sort_decreasing, is_symmetric) {
  validate_metric(new_metric(.f, self_distance, sort_decreasing, is_symmetric))
}
